        ...
        val giveAction = object : JsonObjectRequest(
            ...
            Response.Listener{
                ...
                while (i < data.length()) {
                    ...
                    singleAction.add(paramAction.getJSONObject(0).get("name").toString())
                    singleAction.add(paramAction.getJSONObject(0).get("value").toString())
                    singleAction.add(reaction.get("service").toString())
                    singleAction.add(reaction.get("name").toString())
                    singleAction.add(paramReaction.getJSONObject(0).get("name").toString())
                    singleAction.add(paramReaction.getJSONObject(0).get("value").toString())
